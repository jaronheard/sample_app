...
describe User do
  before { @user = User.new( name: "Example Name", email: "name@example.com", password: "foobar", password_confirmation: "foobar" ) }
  ...
  describe "when email is invalid" do
    it "should be invalid" do
      addresses = %w[user@foo,com user_at_foo.org example.user@foo. foo@bar_baz.com foo@bar+baz.com foo@barbaz..com]
  ...
  describe "it should not allow duplicate email addresses" do
    before do
